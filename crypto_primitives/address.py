...
def recover_public_key(message_hash: bytes, signature: bytes) -> Optional[ecdsa.VerifyingKey]:
    """
    ...
    try:
        ...
        )[v]  # Use v as index to select the correct key from the two candidates
