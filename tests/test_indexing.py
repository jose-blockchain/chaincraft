...
class TestIndexing(unittest.TestCase):
    ...
    def test_pagination(self):
        ...
        results, count = self.node.search_messages("User", "username", "testuser", page=1, page_size=10)
        self.assertEqual(count, 15)
        self.assertEqual(len(results), 10)
        
        # Test second page (5 results)
        results, count = self.node.search_messages("User", "username", "testuser", page=2, page_size=10)
        self.assertEqual(count, 15)
